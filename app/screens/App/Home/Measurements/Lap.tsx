  ...
  return (
    <Layout>
      ...
      <Button 
        ...
        className="self-center rounded-[3px] w-[100px] h-[34px]" buttonTextStyles="text-[13px] leading-[15px] font-bold font-[InterBold] uppercase p-0" onPress={()=>{}} title={i18n.t('lap')}/>
       <Image
        ...
        <Formik
          ...
          validationSchema={Yup.object({
                lap: Yup.string().required(i18n.t('measurement_required'))
            })}
          onSubmit={(values) => {
            (values);
            setFormData((prev)=>(
              ...
              <View className=''>
                <Input
                  ...
                  {touched.lap && errors.lap && (
                    ...
                    className="font-[PoppinsRegular] text-sm mt-1 ml-1 text-red-500">{errors.lap}</Text>
                  )}
              </View>
