  ...
  return (
    <Layout>
      ...
      <Button 
        ...
        className="self-center rounded-[3px] w-[90px] h-[34px]" buttonTextStyles="text-[13px] leading-[15px] font-bold font-[InterBold] uppercase p-0" onPress={()=>{}} 
        title={i18n.t('collar')}/>
       <Image
        ...
        <Formik
          ...
          validationSchema={Yup.object({
                collar: Yup.string().required(i18n.t('measurement_required'))
            })}
          onSubmit={(values) => {
            setFormData((prev)=>(
              {...prev,...values}
            ...
            {({ handleChange, handleBlur, handleSubmit,values, errors, touched }) => (
              ...
              <View className=''>
                <Input
                  ...
                  >
                    <InputField
                      placeholder={i18n.t('enter_collar')}
                      value={values.collar}
                  ...
                  {touched.collar && errors.collar && (
                    <Text 
                      ...
                      className="font-[PoppinsRegular] text-sm mt-1 ml-1 text-red-500">{errors.collar}</Text>
                  )}
              </View>
