  ...
  return (
    <Layout>
      ...
      <Button 
        ...
        className="self-center rounded-[3px] w-[140px] h-[34px]" buttonTextStyles="text-[13px] leading-[15px] font-bold font-[InterBold] uppercase p-0" onPress={()=>{}} title={i18n.t('pant')}/>
       <Image
        ...
        <Formik
          ...
          validationSchema={Yup.object({
                pant: Yup.string().required(i18n.t('measurement_required'))
            })}
          onSubmit={(values) => {
            setFormData((prev)=>(
              {...prev,...values}
              ...
              <View className=''>
                <Input
                  ...
                  {touched.pant && errors.pant && (
                    ...
                    className="font-[PoppinsRegular] text-sm mt-1 ml-1 text-red-500">{errors.pant}</Text>
                  )}
              </View>
              <View className='flex gap-y-[16px]'>
                <Button 
                  ...
                  <Button 
                    ...
                    onPress={()=>navigation.navigate('Paincha')}
                    title={i18n.t('skip')}/>
