  ...
  return (
    <Layout>
      ...
      <Button 
        ...
        className="self-center rounded-[3px] w-[110px] h-[34px]" buttonTextStyles="text-[13px] leading-[15px] font-bold font-[InterBold] uppercase p-0" onPress={()=>{}} title={i18n.t('shoulder')}/>
       <Image
        ...
        <Formik
          ...
          validationSchema={Yup.object({
              shoulder: Yup.string().required(`${i18n.t('measurement_required')}`)
            })}
          onSubmit={(values) => {
            setFormData((prev)=>(
              {...prev,...values}
            ...
            {({ handleChange, handleBlur, handleSubmit, setFieldValue,values, errors, touched }) => (
              ...
              <View className=''>
                <Input
                  ...
                  >
                    <InputField
                      placeholder={i18n.t('enter_shoulder')}
                  ...
                  {touched.shoulder && errors.shoulder && (
                    ...
                    className="font-[PoppinsRegular] text-sm mt-1 ml-1 text-red-500">{errors.shoulder}</Text>
                  )}
              </View>
