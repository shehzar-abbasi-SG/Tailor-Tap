  ...
  return (
    <Layout>
      ...
      <Button 
          ...
          className="self-center rounded-[3px] w-[100px] h-[34px]" buttonTextStyles="text-[13px] leading-[15px] font-bold font-[InterBold] uppercase p-0" onPress={()=>{}} title={i18n.t('arms')}/>
       <Image
        ...
        <Formik
          ...
          validationSchema={Yup.object({
                arms: Yup.string().required(i18n.t('measurement_required'))
            })}
          onSubmit={(values) => {
            setFormData((prev)=>(
              {...prev,...values}
              ...
              <View className=''>
                <Input
                  ...
                  {touched.arms && errors.arms && (
                    ...
                    className="font-[PoppinsRegular] text-sm mt-1 ml-1 text-red-500">{errors.arms}</Text>
                  )}
              </View>
