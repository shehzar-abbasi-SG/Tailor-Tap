          ...
          onSubmit={(values) => {
            ...
            {({ handleChange, handleBlur, handleSubmit,values, errors, touched }) => (
              ...
              <View className=''>
                <Input
                  ...
                  {touched.fitting && errors.fitting && (
                    <Text className="font-[PoppinsRegular] text-sm mt-1 ml-1 text-red-500">{errors.fitting}</Text>
                  )}
              </View>
              <View className='flex gap-y-[16px]'>
                ...
                <Button className="mt-0 bg-transparent h-[50px] rounded-[7px] border-[#38D55B] border-[2px]" buttonTextStyles="text-[22px] leading-[33px] uppercase text-[#38D55B] p-0" onPress={()=>navigation.navigate('Lap')} title="Skip"/>
              </View>
            </>
          )}
        </Formik>
