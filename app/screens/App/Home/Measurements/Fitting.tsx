...
const MeasurementScreenFitting =({navigation}:IMeasurementNavigationProps)=> {
  ...
  return (
    <Layout>
      ...
      <Button 
        ...
        className="self-center rounded-[3px] w-[100px] h-[34px]" buttonTextStyles="text-[13px] leading-[15px] font-bold font-[InterBold] uppercase p-0" onPress={()=>{}} title={i18n.t('fitting')}/>
       <Image
        ...
        />
        <Formik
          initialValues={{ fitting: '' } as PartialClientDetailFormData}
          validationSchema={Yup.object({
                fitting: Yup.string().required(i18n.t('measurement_required'))
            })}
          onSubmit={(values) => {
            setFormData((prev)=>(
              {...prev,...values}
            ))
            navigation.navigate('Lap')
            ...
            {({ handleChange, handleBlur, handleSubmit,values, errors, touched }) => (
              ...
              <View className=''>
                <Input
                  ...
                  {touched.fitting && errors.fitting && (
                    <Text 
                      style={{
                      ...
                      className="font-[PoppinsRegular] text-sm mt-1 ml-1 text-red-500">{errors.fitting}</Text>
                  )}
              </View>
              <View className='flex gap-y-[16px]'>
                <Button 
                  ...
                  <Button 
                    ...
                    onPress={()=>navigation.navigate('Lap')}
                    title={i18n.t('skip')}/>
...
export default MeasurementScreenFitting