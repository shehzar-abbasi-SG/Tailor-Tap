...
const MeasurementScreenPaincha =({navigation}:IMeasurementNavigationProps)=> {
  ...
  return (
    <Layout>
      ...
      <Button className="self-center rounded-[3px] w-[110px] h-[34px]" buttonTextStyles="text-[13px] leading-[15px] font-bold font-[InterBold] uppercase p-0" onPress={()=>{}} title="Paincha"/>
       <Image
          source={require('@/assets/paincha_measurement.png')}
              ...
              <View className=''>
                <Input
                  ...
                  {touched.paincha && errors.paincha && (
                    <Text className="font-[PoppinsRegular] text-sm mt-1 ml-1 text-red-500">{errors.paincha}</Text>
                  )}
              </View>
