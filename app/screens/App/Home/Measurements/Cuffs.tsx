...
const MeasurementScreenCuffs =({navigation}:IMeasurementNavigationProps)=> {
  ...
  return (
    <Layout>
      ...
      className="self-center rounded-[3px] w-[85px] h-[34px]" buttonTextStyles="text-[13px] leading-[15px] font-bold font-[InterBold] uppercase p-0" onPress={()=>{}} title={i18n.t('cuffs')}/>
       <Image
          source={require('@/assets/images/cuffs_measurement.png')}
        ...
        <Formik
          ...
          validationSchema={Yup.object({
                cuffs: Yup.string().required(i18n.t('measurement_required'))
            })}
          onSubmit={(values) => {
            setFormData((prev)=>(
              {...prev,...values}
            ...
            {({ handleChange, handleBlur, handleSubmit,values, errors, touched }) => (
              ...
              <View className=''>
                <Input
                  ...
                  >
                    <InputField
                      placeholder={i18n.t('enter_cuffs')}
                      value={values.cuffs}
                  ...
                  {touched.cuffs && errors.cuffs && (
                    <Text 
                      ...
                      className="font-[PoppinsRegular] text-sm mt-1 ml-1 text-red-500">{errors.cuffs}</Text>
                  )}
              </View>
